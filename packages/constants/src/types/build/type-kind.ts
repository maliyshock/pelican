...
export type TypeKind = FireSourceKind | BuildingKind | CharacterKind | MerchantKind | FoodKind | IngredientKind | HerbKind | FertilizerKind | ResourceKind | PlayerKind | RegionKind | ResourceDepositKind | FuelKind;