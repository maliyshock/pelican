import { EntityType, GameNodeData } from "@pelican/constants";

import { APPLE_TREE, BERRIES_BUSH, DEEP_FOREST, FOREST, LAKE, NUT_TREE, RIVER, STONE_DEPOSIT, TREE } from "../../../common/src/constants/dictionary.ts";
import {
  ANTHILL_DATA,
  BONES_DATA,
  CANE_DATA,
...
import { BERRIES_BUSH_DATA, CLAY_DEPOSIT_DATA, LAKE_DATA, RIVER_DATA, STONE_DEPOSIT_DATA, TREE_DATA } from "../../../common/constants/nodes/resource-deposits";
import { POOP_DATA } from "../../../common/constants/nodes/fertilizer";
import {
  ACORN_DATA,
  APPLE_DATA,
  BERRY_DATA,
  ...
  NUT_DATA,
  WILD_GRAPES_DATA,
} from "../../../common/constants/nodes/food";
