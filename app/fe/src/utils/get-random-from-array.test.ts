...
describe("getRandomFromArray function", () => {
  test("returns the correct element from the array", () => {
    ...
    (getRandom as jest.Mock).mockReturnValue(2); // Mock getRandom to return the index 2
  ...
  test("returns the first element when getRandom returns 0", () => {
    ...
    (getRandom as jest.Mock).mockReturnValue(0); // Mock getRandom to return the index 0
  ...
  test("returns the last element when getRandom returns the last index", () => {
    ...
    (getRandom as jest.Mock).mockReturnValue(2); // Mock getRandom to return the index 2, which is the last index in the array
